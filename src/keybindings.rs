...
impl Action {
    pub(crate) fn name(&self) -> &'static str {
        match self {
            ...
            Action::FilterFailedBlocks => "Show only failed blocks",
            Action::FilterSlowBlocks => "Show only slow blocks",
            Action::FilterPinnedBlocks => "Show only bookmarked blocks",
            Action::ClearBlockFilter => "Show all blocks",
