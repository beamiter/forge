...
|---|---|---|
| bash | `forge.bash` | `~/.bashrc` |
| zsh | `forge.zsh` | `~/.zshrc` |
| fish | `forge.fish` | `~/.config/fish/config.fish` |
| PowerShell | `forge.ps1` | `$PROFILE` |
...
these files under `${prefix}/share/forge/shell-integration/`; the Flatpak copy
is under `/app/share/forge/shell-integration/`.
