...
mod tests {
    ...
    fn new_task(title: &str) -> NewTask {
        NewTask {
            ...
            branch: "forge/task-one".to_string(),
    ...
    fn rejects_ambiguous_or_unsafe_metadata() {
        ...
        task.branch = "forge/valid".to_string();
    ...
    fn session_cannot_be_silently_rebound() {
        ...
        second_task.branch = "forge/task-two".to_string();
    ...
    fn validation_binding_checks_state_running_collisions_and_attempt_overflow() {
        ...
        second_task.branch = "forge/validation-collision".to_string();
        let second = manager.create(second_task).unwrap();
        assert_eq!(
        ...
        agent_task.branch = "forge/agent-session-collision".to_string();
    ...
    fn process_exit_becomes_review_or_failure_before_session_removal() {
        ...
        failed_task.branch = "forge/failed".to_string();
    ...
    fn runtime_selection_survives_stream_end_and_terminal_states_cannot_be_revived() {
        ...
        failed_task.branch = "forge/failed-terminal-bind".to_string();
